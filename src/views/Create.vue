    ...
    <div class="p-8 flex items-start bg-light-grey rounded-md shadow-lg">
      ...
      >
        ...
        <div v-if="workoutType === 'strength'" class="flex flex-col gap-y-4">
          ...
          >
            <div class="flex flex-col md:w-1/3">
              <label
                for="exercise-name"
                class="mb-1 test-sm text-at-light-green"
                >Exercise</label
              >
              <input
                type="text"
            ...
            <div class="flex flex-col flex-1">
              <label for="sets" class="mb-1 test-sm text-at-light-green"
                >Sets</label
              >
              <input
                type="text"
            ...
            <div class="flex flex-col flex-1">
              <label for="reps" class="mb-1 test-sm text-at-light-green"
                >Reps</label
              >
              <input
                type="text"
            ...
            <div class="flex flex-col flex-1">
              <label for="weight" class="mb-1 test-sm text-at-light-green"
                >Weight</label
              >
              <input
                type="text"
        ...
        <div v-if="workoutType === 'cardio'" class="flex flex-col gap-y-4">
          ...
          >
            <div class="flex flex-col md:w-1/3">
              <label for="cardio-type" class="mb-1 test-sm text-at-light-green"
                >Type</label
              >
              <select
                id="cardio-type"
            ...
            <div class="flex flex-col flex-1">
              <label for="distance" class="mb-1 test-sm text-at-light-green"
                >Distance</label
              >
              <input
                type="text"
            ...
            <div class="flex flex-col flex-1">
              <label for="duration" class="mb-1 test-sm text-at-light-green"
                >Duration</label
              >
              <input
                type="text"
            ...
            <div class="flex flex-col flex-1">
              <label for="pace" class="mb-1 test-sm text-at-light-green"
                >Pace</label
              >
              <input
                type="text"
...
export default {
  ...
  setup() {
    ...
    const deleteExercise = (id) => {
      ...
      errorMsg.value = "Error: Can't remove single exercise";
      setTimeout(() => {
        errorMsg.value = null;
      }, 5000);
    };
